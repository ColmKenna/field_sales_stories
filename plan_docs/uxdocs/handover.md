...
**Settled IDs:** T7.1, T7.6, T7.7, T7.8, T7.9, T7.10, T7.11, T7.12, T2.5 (except its clearing rule), H1.6, H1.7, H2.3, H2.6, H2.7, H2.8, H10.1–H10.7, H16.1–H16.3, R1.1–R1.12, R2.1–R2.7, R3.1–R3.5, M1.1–M1.2, M2.1–M2.4, M3.1–M3.4, M4.1–M4.4, M5.1–M5.5, M6.1–M6.6, M7.1–M7.6, M8.1–M8.2, M9.1–M9.4, M10.1–M10.2, M11.1, M11.3, M12.1–M12.2, M13.1–M13.3, M14.1–M14.2, M15.1–M15.3, M16.1–M16.5, M16.7, and the H-01 disposition table.
