...
**Last updated:** 24 Sep 2026 — session paused mid-way through the customer screens. **Resume at §10 "Customer screens — in progress".**
...
| `01-tablet-day.md` | T-01 Sync, T-02 Home, T-03 Agenda, T-04 Search, T-05 Location, T-06 Call & stock check, T-07 Order entry, T-08 Sent item | **All tablet-day screens T-01–T-08 settled (24 Sep 2026).** No tablet-day questions remain open |
...
| `04-user-stories-amendments.md` | BR-NEW-001–007, US-NEW-001–006, amendments to Pricing, Promotions, Area 1, Visit Planning (US-003–US-015), Coverage US-001–US-003, Targets, Stock Allocation; superseded Head Office stories; EC-NEW-001–007; RC-NEW-001–013 | Reflects every settled decision up to the end of the session |
| `05-manager.md` | M-01 to M-15, plus M-16 Add a one-off Visit Due (not in the brief; numbered after M-15 so it doesn't clash with the brief's M-06 Territory assignment) | **All manager screens M-01–M-16 settled** (M16.6 superseded; M11.2 layout deferred to usage feedback). The three logged assumptions were confirmed on 23 Sep 2026: a Region moves with its last Counties (CV001-E2); carve-out Move visits are inherited (CV003-H); the unassigned count is scoped by nearest held geography, not company-wide (M15.2, CV007-D–G). No drafting calls remain in the manager area (M6.6, M7.5, M7.6, M13.3, M14.2 and M15.3 settled 23 Sep 2026). |

| `06-customer.md` | Jobs to be done; C-02 My locations (partial); C-09 Usual products — the landing page, not in the brief, numbered after C-08 | **C-09 settled (24 Sep 2026)** apart from drafting call C9.8 (mark wording). C-02: C2.1 settled; the chain head office buyer and C-05 entry not yet designed |

**Not drawn at all (39 screens):** T-09 to T-14, R-04, C-01, C-03 to C-08, and H-04 to H-09, H-11 to H-15, H-17 to H-30. The head office screens were deliberately deferred, because brief §10 calls them conventional once the patterns settle.

**Tally (24 Sep 2026):** 73 screens (the brief's 71 plus M-16 and C-09). 32 settled; 2 drafted but awaiting confirmation (H-03, C-02); 39 not drawn.
...
C-09 Usual products settled (C9.1–C9.7, C9.9); C2.1 settled. All folded into `06-customer.md`, `04` (US-NEW-007, EC-NEW-008) and `../stories/self-service.md`.

**Session paused here (24 Sep 2026), with this question asked and not yet answered — re-ask it first:**

> **C-02 for a chain buyer** (Hickey's Head Office, 12 branches; C2.1 means they choose on every visit from 13 places plus "Order for several branches"). What does a chain buyer mostly log in to do?
> - **(a) The chain order** — `[ Order for several branches ]` is the primary action at the top; the 13 shops sit below as the exception path.
> - **(b) Single-shop top-ups** — branches phone the buyer; the shop list is the page (needs a filter or most-recently-ordered-for first); the grid is a secondary link.
> - **(c) Both about equally** — two primary actions of equal weight (precedent: T5.1).

Also awaiting Colm: **C9.8** mark wording (asked alongside C9.9, not answered — confirm in the batch of drafting calls, don't press).
...
2. **C-02** — the chain head office buyer (Hickey's Head Office, 12 branches) and the entry to C-05.
3. **C-04** — editing while Pending now orders are accepted on receipt (Self-service RC 7).
4. **C9.8** — confirm mark wording ("your rep", colleague's name, chain head office by name).
